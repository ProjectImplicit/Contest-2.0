...
<tr><td>
    ...
    <p class="text">All participants in this study completed one or more IATs. Prior to doing the IAT, some participants completed a task designed to change how their implicit associations would be expressed on the IAT. You could have been assigned to one of nine tasks or no task at all. These nine tasks fell into one of three categories:
	<p class = "text"><b>Considering Counterstereotypical Associations.</b> These tasks gave participants experiences with positive Black people and negative White people. These experiences varied widely in their complexity. In the more basic tasks, participants played categorization games where they paired Black people with Good words and White people with Bad words. In more complex tasks, participants participated in a narrative where Black people are their friends and White people are their enemies.</p>
	<p class = "text"><b>Affirming Egalitarian Values.</b> One manipulation attempted to induce an egalitarian mindset by writing a short essay about multiculturalism.</p>
	<p class = "text"><b>Strategies to Overcome Implicit Bias.</b> Rather than changing implicit associations directly, participants in these tasks were given strategies to take control of their implicit biases. One task gave instructions on how to "cheat" the IAT, while another approach instructed participants to set the plan: "If I see a Black face, I will think good!"</p>
	<p class="text">We will compare how different types of experiences influence the results to learn something about the IAT and  what it assesses. You were also asked to take the IAT a second time to assess the impact of these experiences over time. Some experiences may have fleeting effects, while others may induce psychological change that lasts. If you would like to find out more information about the various tasks and their rationales, you can obtain a copy of the manuscript at <a href="http://papers.ssrn.com/sol3/papers.cfm?abstract_id=2155175">this link.</a></p>
	<p class="text">You completed a Implicit Association Test, measuring your associations of White and Black people with good and bad words.  Your results from the Implicit Association Test you just completed are reported below: </p>
	</td>
</tr>
