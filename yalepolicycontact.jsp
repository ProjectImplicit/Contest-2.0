...
String[][][] collact =
{
{{"collact"}, {"nelem","3"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","3.3"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>How willing would you be to engage in the following behavior?</b><br/>"}},
{{"collact1"},{"stem","I would sign a petition in support of improving the socio-economic situation of Black Americans."}},
{{"collact2"},{"stem","I would join a peaceful protest to advocate for a better socio-economic situation for Black Americans."}},
{{"collact3"},{"stem","I would take collective action to help improve the socio-economic situation of  Black Americans."}},
};  
String[][][] contact =
{
{{"contact"}, {"nelem","2"},{"choices","frequency"},{"musthave","0"},{"group","0"},{"gminmax","2.2"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/><b>Using the provided scale, please indicate how frequently you have personal contact with Black people.</b></br>"}},
{{"contact1"},{"stem","How often do you have <b>good or positive</b> contact with Black people?"}},
{{"contact2"},{"stem","How often do you have <b>bad or negative</b> contact with Black people?"}},
};  
String[][][] typi =
{
{{"typi"}, {"nelem","2"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","2.2"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>Please indicate how you view the Black people with whom you have contact.</b><br/>"}},
{{"typi1"},{"stem","The Black people with whom I have personal contact are very much like other Blacks."}},
{{"typi2"},{"stem","The Black people with whom I have personal contact are similar to Blacks in general."}},
};  
