...
<tr><td>
	...
	<p class="text"><strong><font size="4">ASSIGNED CONFIRMATION CODE: MGY884</strong><font></p>
	<p class="text"><strong><font size="4">Email the confirmation code and your 6-digit research (SONA) ID to <a href="meghan.mclean@rutgers.edu">meghan.mclean@rutgers.edu</a> to receive your RPU!</strong><font></p>
