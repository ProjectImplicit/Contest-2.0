...
{{"frequency"},{"options","1 - Never","2 - Rarely","3 - Sometimes","4 - Often","5 - Always"}},
};
String[][][] healthbeh =
{
{{"healthbeh"}, {"nelem","8"},{"choices","frequency"},{"musthave","0"},{"group","0"},{"gminmax","8.8"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>Indicate how often you engage in the following behaviors, using the scale given.</b>"}},
{{"healthbeh1"},{"stem","Eat at least two servings of vegetables per day"}},
{{"healthbeh2"},{"stem"," Eat at least two servings of fruit per day"}},
{{"healthbeh3"},{"stem"," Exercise for at least 30 min at least three times a week"}},
{{"healthbeh4"},{"stem"," Brush your teeth at least twice a day"}},
{{"healthbeh5"},{"stem"," Floss your teeth at least once a day"}},
{{"healthbeh6"},{"stem"," Eat red meat twice a week or more"}},
{{"healthbeh7"},{"stem"," Drink soda twice a week or more"}},
{{"healthbeh8"},{"stem"," Sleep at least 7 hours at night"}},
};  

ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
  scales.add(healthbeh);
