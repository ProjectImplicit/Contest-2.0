...
<%
       ...
       iatfeedback = mysession.v("5b_iatc_set1_post.feedback");
       if (iatfeedback==null) iatfeedback=mysession.v("5b_iatd_set1_post.feedback");
       if (iatfeedback==null) iatfeedback=mysession.v("5b_iatc_set2_post.feedback");
       if (iatfeedback==null) iatfeedback=mysession.v("5b_iatd_set2_post.feedback");
      }
...
<tr><td>
	...
	<p class = "text"><b>Strategies to Overcome Implicit Bias.</b> Rather than changing implicit associations directly, participants in these tasks were given strategies to override the expression of their implicit bias on the IAT. One task gave instructions on how to "cheat" the IAT, while another approach instructed participants to set the plan: "If I see a Black face, I will think good!"</p>
	<p class="text">We will compare how different types of experiences influence the results of the measure to learn something about the IAT and about what it assesses. You may also take the IAT a second time to assess the impact of these experiences over time. Some experiences may have fleeting effects, while others may induce psychological change that lasts. As such, if your measure was particularly effective at shifting your implicit responses, you may be interested to return to the demonstration site in the future, and try out the race task again to see if your results are the same or different. If you would like to find out more information about the various tasks and their rationales, you can obtain a copy of the manuscript at <a href="http://papers.ssrn.com/sol3/papers.cfm?abstract_id=2155175">this link.</a></p>
