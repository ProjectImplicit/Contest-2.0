...
{{"agree"},{"options","1 - Strongly disagree", "2 - Disagree", "3 - Somewhat disagree","4 - Neither agree nor disagree","5 - Somewhat agree", "6 - Agree", "7 - Strongly agree"}},
{{"continue"},{"options","Continue"}},
{{"situation"},{"options","10 - Best possible situation", "9", "8", "7", "6", "5", "4", "3", "2", "1", "0 - Worst possible situation"}},
{{"frequency"},{"options","1 - Never", "2 - Very rarely", "3 - Somewhat rarely","4 - Sometimes", "5 - Somewhat often","6 - Very often","7 - Almost always"}},
};
String[][][] solid =
{
{{"solid"}, {"nelem","3"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","3.3"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>Now, please indicate how you, as a Pacific Islander, feel toward Black people.</b><br/>"}},
{{"solid1"},{"stem","As a Pacific Islander, I feel solidarity with Black people."}},
{{"solid2"},{"stem","As a Pacific Islander, I feel a sense of unity when I\'m with Black people."}},
{{"solid3"},{"stem","As a Pacific Islander, I feel committed to Black people."}},
};  
String[][][] ladderintro =
{
{{"ladderintro"}, {"nelem","1"},{"choices","continue"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/><br/><br/><b><font size=&#34;4&#34;>Please imagine a ladder with steps from 10 at the top to 0 at the bottom. The top of the ladder represents the best possible socio-economic situation for a group in America, and the bottom of the ladder represents the worst possible socio-economic situation for a group in America.</font></b><br/>"}},
{{"ladderintro"},{"stem",""}},
};  
String[][][] ladder =
{
{{"ladder"}, {"nelem","8"},{"choices","situation"},{"musthave","0"},{"group","0"},{"gminmax","8.8"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/><b>Using the ladder scale, indicate how you view the socio-economic situation of groups in America.</b><br/>"}},
{{"ladder_t1"},{"stem","On which step of the ladder do <b>Black people</b> stand <b>today</b>?"}},
{{"ladder_t2"},{"stem","On which step of the ladder do <b>Pacific Islanders</b> stand <b>today</b>?"}},
{{"ladder_p1"},{"stem","On which step of the ladder did <b>Black people</b> stand <b>five years ago</b>?"}},
{{"ladder_p2"},{"stem","On which step of the ladder did <b>Pacific Islanders</b> stand <b>five years ago</b>?"}},
{{"ladder_f1"},{"stem","On which step of the ladder will <b>Black people</b> stand <b>five years from now</b>?"}},
{{"ladder_f2"},{"stem","On which step of the ladder will <b>Pacific Islanders</b> stand <b>five years from now</b>?"}},
{{"ladder_j1"},{"stem","On which step of the ladder should <b>Black people</b> stand, if they had their <b>rightful place in America</b>?"}},
{{"ladder_j2"},{"stem","On which step of the ladder should <b>Pacific Islanders</b> stand, if they had their <b>rightful place in America</b>?"}},
};  
String[][][] illeg =
{
{{"illeg"}, {"nelem","3"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","3.3"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>Please evaluate the current situation of Black people, using the given scale.</b><br/>"}},
{{"illeg1"},{"stem","The current socio-economic situation of Blacks, compared to Pacific Islanders, is unfair."}},
{{"illeg2"},{"stem","The current socio-economic situation of Blacks, compared to Pacific Islanders, is acceptable."}},
{{"illeg3"},{"stem","The current socio-economic situation of Blacks, compared to Pacific Islanders, is socially unjust."}},
};  
String[][][] guilt =
{
{{"guilt"}, {"nelem","3"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","3.3"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>How do you feel about being a Pacific Islander in America?</b><br/>"}},
{{"guilt1"},{"stem","I feel guilt due to my association with the White racial group."}},
{{"guilt2"},{"stem","I feel guilty about the past and present social inequality of Black Americans."}},
{{"guilt3"},{"stem","I feel guilty about the benefits and privileges that I receive as a Pacific Islander American."}},
};  
String[][][] policy =
{
{{"policy"}, {"nelem","6"},{"choices","agree"},{"musthave","0"},{"group","0"},{"gminmax","6.6"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b>Please indicate your agreement with the following statement.</b><br/>"}},
{{"policy1"},{"stem","To create a level playing field, we should spend much more money on schools in largely Black neighborhoods, especially for early education programs."}},
{{"policy2"},{"stem","We must introduce programs that help to skill historically disadvantaged groups so that they can compete fairly with Pacific Islanders for jobs and promotions."}},
{{"policy3"},{"stem","Black people are already in a position where they can fairly compete with Pacific Islanders, if they want to."}},
{{"policy4"},{"stem","After years of discrimination, we should adopt affirmative action policies to facilitate the hiring and promotion of Black people."}},
{{"policy5"},{"stem","Historically disadvantaged groups should receive racial entitlements and compensations to make up for past injustices."}},
{{"policy6"},{"stem","Black people have to learn they are no longer entitled to special consideration and must make it strictly on merit."}},
};  
ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
  scales.add(solid);
  scales.add(ladderintro);  
  scales.add(ladder);
  scales.add(illeg);
  scales.add(guilt);
  scales.add(policy);
