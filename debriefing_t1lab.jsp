...
<tr><td>
    ...
    <p class="text">Thank you for completing the first phase of the study! In twenty-four hours, you will be contacted via email complete the second phase of the study. The second phase will only take about five minutes. Please complete it as soon as you can when you receive it. After you have completed that phase, we will give you feedback about your results. So that others are not influenced before they participate, please do not discuss this study with anyone else.</p>
	<p class="text">Please contact the experimenter who will tell you about what will happen next.</p>
	<br/><br/>
 </td>
</tr>
...
<br><h1 align="center"><script language="JavaScript" type="text/javascript">writeButton("For Experimenters Only - DO NOT CLICK");</script></h1>
</body>
</html>
