...
<%
  class SendEmail implements Runnable {
    ...
    public void run() {
     ...
     String Subject = "Time-sensitive: Follow-Up Session for Psychology Study";
	 String fromEmail = "Thierry Devos<tdevos@mail.sdsu.edu>";
