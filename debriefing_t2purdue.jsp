...
<tr><td>
	...
	<p class="text">If you have any questions about this study please email the lead investigator, Calvin Lai (<a href="mailto:ckl5ae@virginia.edu">ckl5ae@virginia.edu</a>) or Dr. Margo Monteith (<a href="mailto:mmonteit@purdue.edu">mmonteit@purdue.edu</a>, 765-496-9461).  If you have concerns about the treatment of research participants, you can contact the Institutional Review Board (IRB) at Purdue University, Ernst C. Young Hall, 10th floor- room 1032, 155 S. Grant Street, West Lafayette, IN 47907-2114. The IRB’s phone number is (765) 494-5942.  The email address is <a href="mailto:irb@purdue.edu">irb@purdue.edu</a>.</p>
		</td>
</tr>
</table>
</td>
