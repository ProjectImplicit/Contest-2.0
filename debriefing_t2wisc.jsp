...
<tr><td>
	...
	<p class="text">If you have any questions about this study please email the  investigator, Sohad Murrar (<a href="mailto:smurrar@wisc.edu">smurrar@wisc.edu</a>).</p>
		</td>
</tr>
</table>
</td>
