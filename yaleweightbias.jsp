...
{{"good"},{"options","1 - very bad","2 - bad","3 - slightly bad","4 - neither bad nor good","5 - slightly good","6 - good","7- very good"}},
{{"motivated"},{"options","1 - very lazy","2 - lazy ","3 - slightly lazy ","4 - neither lazy nor motivated","5 - slightly motivated","6 - motivated","7- very motivated"}},
{{"smart"},{"options","1 - very stupid","2 - stupid ","3 - slightly stupid ","4 - neither stupid nor smart","5 - slightly smart ","6 - smart","7- very smart"}},
{{"valuable"},{"options","1 - very worthless", "2 - worthless ","3 - slightly worthless ","4 - neither worthless nor valuable","5 - slightly valuable","6 - valuable","7- very valuable"}},
};
String[][][] weightbias =
{
{{"weightbias"}, {"nelem","8"},{"musthave","0"},{"group","0"},{"gminmax","8.8"},{"gplace","0"},{"gorder","0"},{"gsequence","random"},{"prefix","<br/><b> Indicate your beliefs about fat and thin people using the scales given. Please answer honestly.</b>"}},
{{"weightbias1"},{"choices","good"},{"stem","Fat people are..."}},
{{"weightbias2"},{"choices","good"},{"stem","Thin people are..."}},
{{"weightbias3"},{"choices","motivated"},{"stem","Fat people are..."}},
{{"weightbias4"},{"choices","motivated"},{"stem","Thin people are..."}},
{{"weightbias5"},{"choices","smart"},{"stem","Fat people are..."}},
{{"weightbias6"},{"choices","smart"},{"stem","Thin people are..."}},
{{"weightbias7"},{"choices","valuable"},{"stem","Fat people are..."}},
{{"weightbias8"},{"choices","valuable"},{"stem","Thin people are..."}},
};  

ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
  scales.add(weightbias);
