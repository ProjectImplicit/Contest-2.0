...
{{"rate1"},{"options","Not at all", "Slightly", "Somewhat", "Very much", "A great deal"}}, 
{{"rate2"},{"options","No effort","Slight effort","Moderate effort","Strong effort", "Extreme effort"}}, 
};
            
String[][][] effort =
{
{{"effort"}, {"nelem","2"},{"musthave","0"},{"group","0"},{"gminmax","2.2"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix",""}}, 
{{"effort1"},{"choices","rate1"},{"stem","Did you care about your performance in the study?"}},
{{"effort2"},{"choices","rate2"},{"stem","What level of effort did you put forth in the study?"}},
};                 
