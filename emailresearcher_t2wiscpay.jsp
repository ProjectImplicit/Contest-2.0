...
<%
  class SendEmail implements Runnable {
    ...
    public void run() {
     ...
     String Subject = "Completed Session for Contest Project - Session 2";
	 ...
	 String toResearcher="smurrar@wisc.edu";
	 long sessionId=studySession.getId();
	 int delay=1;
	 String bodyText="A person with the following email address has completed the second session: "+ParticipantEmail+"";
